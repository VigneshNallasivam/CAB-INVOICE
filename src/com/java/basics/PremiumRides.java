...
public class PremiumRides
{
	 public static int costPerKms=10;
	    ...
	    static List<RideRepository2> userList = new ArrayList<RideRepository2>();



	    public static double generateInvoiceAsPerUserID(int id) {
	        RideRepository2 user1 = new RideRepository2(1,10.0,20.0);
	        RideRepository2 user2 = new RideRepository2(2,20.0,40.0);
	        RideRepository2 user4 = new RideRepository2(1,10.0,20.0);
	        RideRepository2 user5 = new RideRepository2(2,20.0,40.0);	       
	        RideRepository2 user3 = new RideRepository2(3,30.0,60.0);
	        userList.add(user1);
	        userList.add(user2);
	        userList.add(user3);
	        userList.add(user4);
